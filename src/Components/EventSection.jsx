      ...
      <div className="container">
        ...
        <div className="quality-section text-center my-8">
          ...
          <p className="label-1 mx-auto max-w-2xl">
            Consumers today demand high-quality seafood year-round, and we
            ensure this at every step with sustainable methods aimed at a better
            tomorrow. ASMAK is extremely cautious about hygiene and the
            meticulous processing of marine products. Every item undergoes
            strict quality control, so our customers enjoy only the finest,
            whether fresh or frozen. All products from our facility are handled
            with care and transported under optimal conditions to clients across
            the globe.
          </p>
        </div>
        ...
        <ul className="grid-list">
          ...
          <li>
            <div className="event-card has-before hover:shine">
              <div
                className="card-banner img-holder2"
